...
import { HStack, VStack, Text, IconButton, Button, Box, Flex} from "@chakra-ui/react";
import { SpeakerWaveIcon, PencilIcon, ArrowDownTrayIcon, CheckCircleIcon } from "@heroicons/react/24/outline"
        ...
        {showExportOptions ?  (
          <HStack bg="white" borderRadius="full" p={4} px={5}>
            ...
            <Flex flexDirection="column">
              <Box>
              <Text fontSize="sm" fontWeight="bold" color="teal">Export as ...</Text>
              </Box>
              <HStack>
                <Button variant='link' size='sm' color='gray.500'>PNG</Button>
                <Button variant='link' size='sm' color='gray.500'>PDF</Button>
                <Button variant='link' size='sm' color='gray.500'>UML</Button>
              </HStack>
            </Flex>
          </HStack> ) : (
          <VStack>
